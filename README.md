...
**Cloud/DevOps:** GCP · Azure · Kubernetes · Git · Firestore  
**AI/ML:** PyTorch · TensorFlow · scikit-learn · FAISS (Vector DB) · RAG · MCP · NLP · Deep Learning · Reinforcement Learning · ROS 2 · Computer vision
**Blockchain/Web3:** Solana · Solidity · Web3.js · DeFi · ZKP · dApps  
**Systems/Security:** Kali Linux · Bash · (…)
